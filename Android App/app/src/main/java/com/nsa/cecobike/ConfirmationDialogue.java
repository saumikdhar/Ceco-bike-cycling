...
public class ConfirmationDialogue extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Confirmation") //change the dialog box header here
                .setMessage("Are you sure you want to delete this Journey") // change/input the emmissions saved here
                .setCancelable(true)
